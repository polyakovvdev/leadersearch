    ...
    <header class="header">
      <div class="header__content">
        <div class="header__caption">
          <a href="/">
            <img src="../../template/img/logo.svg" alt="Лидер Поиска" />
          </a>
        </div>
        <a href="/cart/" class="header__cart">
          <svg class="cart-logo" width="28" height="23" viewBox="0 0 28 23" xmlns="http://www.w3.org/2000/svg">
          ...
          <span>Корзина</span>
          <?php $isHidden = (Cart::countItems() < 1) ? "hidden" : "" ?>
          <div class="items-count" style="visibility: <?php echo $isHidden ?>"><?php echo Cart::countItems(); ?></div>
        </a>
      </div>
    </header>
  </div>